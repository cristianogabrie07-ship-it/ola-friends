  ...
  return (
    <section className="w-full py-8 bg-[#050505]">
      <div className="mx-auto max-w-7xl px-4">
        <h2 className="text-lg font-bold uppercase tracking-wider text-[#E00000] mb-6">Categorias</h2>
            ...
            return (
              <motion.button
                ...
                className={`flex flex-col items-center gap-2 min-w-[90px] px-4 py-4 rounded-xl border transition-all ${
                  isActive
                    ? "bg-[#1A1A1A] border-[#E00000] text-[#E00000]"
                    : "bg-[#0D0D0D] border-[#E0000022] text-[#A0A0A0] hover:border-[#E0000055]"
                }`}
              >
                <Icon size={24} />
