    ...
    <header className="w-full bg-[#050505] text-white sticky top-0 z-50">
      ...
      <div className="container mx-auto px-4 md:px-6 py-3 md:py-4 flex items-center justify-between">
        ...
        <Link to="/" className="flex-shrink-0">
          <span className="text-lg md:text-xl font-bungee tracking-tight text-[#C9A84C]">
            MARTINS
          </span>
          <span className="text-lg md:text-xl font-bungee tracking-tight text-white ml-1">
            MULTIMARCAS
          </span>
        </Link>
      ...
      {isMenuOpen && (
        <nav className="md:hidden border-t border-[#C9A84C11] bg-[#050505] animate-in slide-in-from-top duration-200">
          <div className="container mx-auto px-4 py-5 flex flex-col gap-4 text-sm font-bold uppercase tracking-widest">
